 ...
 *
 * This I/O scheduler has been modified to  incorporate several fixes 
 * and logic improvements from the plus version.
 * 
 * TODO:
 * Change type of sio_init_queue to void *.
 * This change will require several modifications to various files,
 * not to mention compatibitlity fixes and avoiding compilation errors.
